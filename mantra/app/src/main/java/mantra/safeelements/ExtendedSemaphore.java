...
/**
 * An extended class for storing not only the semaphore status but also the
 * identifier of the thread owning the semaphore
 */
public class ExtendedSemaphore extends Semaphore {
	 ...
	 * 
	 * @return true if the semaphore is locked by the current thread, false
	 *         otherwise
	 */
