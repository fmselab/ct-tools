...
public class Operations {
	 ...
	 */
	public static BooleanFormula createCtxFromModel(CitModel model, TestContext ctx, Map<Parameter, List<Formula>> variables) {
	 ...
	 */
	public static BooleanFormula addConstraintsForEnumeratives(CitModel model, TestContext ctx, Map<Parameter, List<Formula>> variables) {
	...
	/**
	 * Checks if in the map there is an entry with the key that starts with the given prefix and return the name
	 * 
