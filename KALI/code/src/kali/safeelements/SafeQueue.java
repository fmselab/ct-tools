...
public class SafeQueue {
	...
	ConcurrentLinkedQueue<Vector<Pair<String, Object>>> tupleList;
	...
	public SafeQueue() {
		...
		tupleList = new ConcurrentLinkedQueue<Vector<Pair<String, Object>>>();
		nTuples = 0;
	}
	 ...
	 */
	public void insert(Vector<Pair<String, Object>> tuple) {
		tupleList.add(tuple);
		nTuples++;
	}
	 ...
	 */
	public Vector<Pair<String, Object>> get() {
