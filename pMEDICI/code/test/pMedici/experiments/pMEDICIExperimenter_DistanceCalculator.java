...
public class pMEDICIExperimenter_DistanceCalculator {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		for (int i = 0; i < 1000; i++) {
			...
			newTestSuite = "CSVTest_AmbientAssistedLivingv2.csv";
			...
			PMedici_withTestSuiteExport.main(new String[] { "2", evolvedModelPath, exportFilePath});
			...
			newTestSuite = "CSVTest_AutomotiveMultimediav2.csv";
			...
			consoleManger.consolePrintingOff();
			PMedici_withTestSuiteExport.main(new String[] { "2", evolvedModelPath, exportFilePath});			consoleManger.consolePrintingOn();
			distance=DistancesCalculatorLight.percTestSuitesDist_FromTestSuites_CTW(oldModelPath, oldTestSuiteFilePath, ",", evolvedModelPath, exportFilePath, ";");
			System.out.println("Distance TS-TS': " + distance + "%");
			...
			newTestSuite = "CSVTest_AutomotiveMultimediav3.csv";
			...
			newTestSuite = "CSVTest_Boeingv2.csv";
			...
			newTestSuite = "CSVTest_Boeingv3.csv";
			...
			newTestSuite = "CSVTest_CarBodyv2.csv";
			...
			newTestSuite = "CSVTest_CarBodyv3.csv";
			...
			newTestSuite = "CSVTest_CarBodyv4.csv";
			...
			newTestSuite = "CSVTest_LinuxKernelv2.csv";
			...
			newTestSuite = "CSVTest_LinuxKernelv3.csv";
			...
			newTestSuite = "CSVTest_ParkingAssistantv2.csv";
			...
			newTestSuite = "CSVTest_ParkingAssistantv3.csv";
			...
			newTestSuite = "CSVTest_ParkingAssistantv4.csv";
			...
			newTestSuite = "CSVTest_ParkingAssistantv5.csv";
			...
			newTestSuite = "CSVTest_PPUv2.csv";
			...
			newTestSuite = "CSVTest_PPUv3.csv";
			...
			newTestSuite = "CSVTest_PPUv4.csv";
			...
			newTestSuite = "CSVTest_PPUv5.csv";
			...
			newTestSuite = "CSVTest_PPUv6.csv";
			...
			newTestSuite = "CSVTest_PPUv7.csv";
			...
			newTestSuite = "CSVTest_PPUv8.csv";
			...
			newTestSuite = "CSVTest_PPUv9.csv";
			...
			newTestSuite = "CSVTest_SmartHotelv2.csv";
			...
			newTestSuite = "CSVTest_SmartWatchv2.csv";
			...
			newTestSuite = "CSVTest_WeatherStationv2.csv";
